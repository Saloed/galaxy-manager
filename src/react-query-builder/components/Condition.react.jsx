...
import {Button, InputGroup, FormGroup, HTMLSelect, ControlGroup, TextArea} from "@blueprintjs/core";
            ...
            <div className="query condition">
                <ControlGroup fill={false} vertical={false}>
                    <InputGroup className="operand name" defaultValue={this.props.query.fieldName}
                                onChange={this.onFieldNameChange} placeholder={"name"}/>
                    ...
                    <TextArea  className="operand description" value={this.props.query.description}
                                onChange={this.onFieldDescriptionChange}  placeholder={"description"} small={true} large={false}/>
                    <Button className="conditionButton removeCondition" icon={"trash"} onClick={this.removeSelf}
                            text={"Delete"}/>
                </ControlGroup>
            </div>
        );
